<?php
	/**
	 * Template Name: Page: Privacy Policy page
	 */
		...
		<div class="policy__inner">
			<div class="policy__content">
				...
				<div class="policy__text">
					...
					<h3>Definitions</h3>
					<h5><b>For the purposes of this Privacy Policy:</b></h5>
					<ul>
						<li>
						...
						<li>
							<b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SYOAK LLC, 4300 BISCAYNE BLVD SUITE 203 MIAMI, FL 33137.
						</li>
						<li>
						...
						<li><b>Country</b> refers to: Florida, United States</li>
						...
						<li><b>Website</b> refers to billimd.com, accessible from <a href="https://billimd.com/">https://billimd.com/</a></li>
					...
					<h4>Personal Data</h4>
					<h5>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</h5>
					<ul>
						<li>
							Email address
						</li>
					...
					<h5>The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:</h5>
					<ul>
						<li>
							Google
						</li>
					...
					<h5>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</h5>
					<ul>
						<li>
					...
					<ul>
						...
						<li>
							...
							<div><span>Purpose:</span>These Cookies are used to track information about traffic to the Website and how users use the Website. The information gathered via these Cookies may directly or indirectly identify you as an individual visitor. This is because the information collected is typically linked to a pseudonymous identifier associated with the device you use to access the Website. We may also use these Cookies to test new pages, features or new functionality of the Website to see how our users react to them.</div>
						</li>
					</ul>
					...
					<h5>The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</h5>
					<ul>
					...
					<h3>Analytics</h3>
					<h5>We may use third-party Service providers to monitor and analyze the use of our Service.</h5>
					<ul>
						<li>
							<span class="ul-title">
								Google Analytics
							...
							<div class="dblock">
								...
								<p><b>For more information on the privacy practices of Google, please visit the Google Privacy & Terms web page:</b> <a href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a></p>
							</div>
						</li>
					</ul>
					...
					<h3>Contact Us</h3>
					<h5>If you have any questions about this Privacy Policy, You can contact us:</h5>
					<ul>
